 ...
 * Use the {@link PhongTroFragment#newInstance} factory method to
...
public class PhongTroFragment extends Fragment {
     ...
     * @return A new instance of fragment PhongTroFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Phòng Trọ");
        return inflater.inflate(R.layout.fragment_phong_tro, container, false);
    }
}