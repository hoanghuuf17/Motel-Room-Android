...
public class ChungCuFragment extends Fragment {
    ...
    private ChungCuViewModel mViewModel;
    private View view;
    ...
    public static ChungCuFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.chung_cu_fragment, container, false);
        init();
        return view;
    }
    ...
    private void init() {
        ...
        recyclerView = view.findViewById(R.id.recyclerChungCu);
    ...
    private void getCategorys() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Constant.CATEGOTY+'4', response -> {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ChungCuViewModel.class);
