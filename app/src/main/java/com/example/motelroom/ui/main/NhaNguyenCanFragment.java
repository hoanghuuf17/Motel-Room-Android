...
public class NhaNguyenCanFragment extends Fragment {
    ...
    public static NhaNguyenCanFragment newInstance() {
        return new NhaNguyenCanFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.nha_nguyen_can_fragment, container, false);
        init();
        return view;
    }
    ...
    private void init() {
        ...
        recyclerView = view.findViewById(R.id.recyclerNhaNguyenCan);
    ...
    private void getCategorys() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Constant.CATEGOTY+'3', response -> {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(NhaNguyenCanViewModel.class);
